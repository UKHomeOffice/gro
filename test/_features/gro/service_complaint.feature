@feature @service-complaint

Feature: Service complaint

  Scenario: I am on the Service complaint (about-radio-complaint) journey, I ordered a birth certificate online,
  ...
  On the confirm page I want to change the reason for contact and type of certificate.
    ...
    Then I fill 'details-text' text area with 'Complaint Details'
  ...
  Scenario: I am on the Service complaint (about-radio-complaint) journey, I ordered a marriage certificate
  ...
  Scenario: I am on the Service complaint (about-radio-complaint) journey, I ordered a death certificate
  online and paid for the standard service.
  On the confirm page I want to change the reason for contact and type of certificate.
    Given I start the 'base' application journey
    Then I should be on the 'about' page showing 'Which type of order are you contacting us about?'
  ...
  Scenario: I am on the Service complaint (about-radio-complaint) journey, I ordered a adoption certificate
  online and paid for the standard service.
  On the confirm page I want to change the reason for contact and type of certificate.
    Given I start the 'base' application journey
    Then I should be on the 'about' page showing 'Which type of order are you contacting us about?'
  ...
  Scenario: I am on the Service complaint (about-radio-complaint) journey, I ordered a Civil partnership
  ...
  Scenario: I am on the Service complaint (about-radio-complaint) journey, I ordered a birth certificate on
