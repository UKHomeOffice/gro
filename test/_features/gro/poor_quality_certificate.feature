@feature @poor-quality-certificate

Feature: Poor quality certificate

  Scenario: I am on the Poor quality certificate (about-radio-damaged) journey, I ordered a birth certificate online,
  ...
  On the confirm page I want to change the reason for contact and Type of certificate.
    ...
    Then I choose 'Birth'
    Then I click the 'Continue' button
    Then I should be on the 'person' page showing 'Whose name, including all middle names, is on the certificate you received?'
  ...
  Scenario: I am on the Certificate not received (about-radio-damaged) journey, I ordered a marriage certificate
  ...
  Scenario: I am on the Poor quality certificate (about-radio-damaged) journey, I ordered a death certificate
  online and paid for the standard service.
  On the confirm page I want to change the reason for contact and type of certificate.
    Given I start the 'base' application journey
    Then I should be on the 'about' page showing 'What would you like to contact us about?'
