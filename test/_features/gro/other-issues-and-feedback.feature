@feature @other-issues-and-feedback

Feature: Other issues and feedback

  Scenario: I am on the Other issues and feedback (about-radio-other) journey, I ordered a birth certificate online,
  ...
  On the confirm page I want to change the reason for contact and type of certificate.
    ...
    Then I fill 'details-text' text area with 'Enquiry Details'
    ...
    Then I should see 'Reason for contact' and 'Other issues and feedback' on the page
    Then I should see 'Type of certificate' and 'Birth' on the page
    Then I should see 'Further description' and 'Enquiry Details' on the page
    Then I should see 'About an existing order?' and 'Yes' on the page
    Then I should see 'Have you already enquired about this issue?' and 'Yes' on the page
  ...
  Scenario: I am on the Other issues and feedback (about-radio-other) journey, I ordered a marriage certificate
  ...
  Scenario: I am on the Other issues and feedback (about-radio-other) journey, I ordered a death certificate
  online and paid for the standard service.
  On the confirm page I want to change the reason for contact and type of certificate.
    Given I start the 'base' application journey
    Then I should be on the 'about' page showing 'Which type of order are you contacting us about?'
  ...
  Scenario: I am on the Other issues and feedback (about-radio-other) journey, I ordered a adoption certificate
  online and paid for the standard service.
  On the confirm page I want to change the reason for contact and type of certificate.
    Given I start the 'base' application journey
    Then I should be on the 'about' page showing 'Which type of order are you contacting us about?'
  ...
  Scenario: I am on the Other issues and feedback (about-radio-other) journey, I ordered a Civil partnership
  ...
  Scenario: I am on the Other issues and feedback (about-radio-other) journey, I ordered a birth certificate on
