@feature @wrong-certificate-received

Feature: Wrong certificate received

  Scenario: I am on the Wrong certificate received (about-radio-wrong-certificate) journey, I ordered a birth certificate online,
  ...
  On the confirm page I want to change the reason for contact and Type of certificate.
    ...
    Then I fill 'additional-names' text area with 'Person Name C'
  ...
  Scenario: I am on the Certificate not received (about-radio-wrong-certificate) journey, I ordered a marriage certificate
  ...
  Scenario: I am on the Wrong certificate received (about-radio-wrong-certificate) journey, I ordered a death certificate
  online and paid for the standard service.
  On the confirm page I want to change the reason for contact and type of certificate.
    Given I start the 'base' application journey
    Then I should be on the 'about' page showing 'Which type of order are you contacting us about?'
  ...
  Scenario: I am on the Wrong certificate received (about-radio-wrong-certificate) journey, I ordered a adoption certificate
  online and paid for the standard service.
  On the confirm page I want to change the reason for contact and type of certificate.
    Given I start the 'base' application journey
    Then I should be on the 'about' page showing 'Which type of order are you contacting us about?'
  ...
  Scenario: I am on the Wrong certificate received (about-radio-wrong-certificate) journey, I ordered a Civil partnership
  ...
  Scenario: I am on the Wrong certificate received (about-radio-wrong-certificate) journey, I ordered a birth certificate on
  ...
  Scenario: I am on the Wrong certificate received (about-radio-wrong-certificate) journey, I ordered a marriage certificate
